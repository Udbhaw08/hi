...
class CameraReader:
    ...
    def __init__(self, source, backend=None):
        # Default backend sees iVCam; DirectShow sees physical webcam
...
def main():
    ...
    parser.add_argument('--cam', type=int, default=0, help="Camera index (default: 0 = iVCam)")
    parser.add_argument('--threshold', type=float, default=0.45, help="Match threshold (default: 0.45)")
    ...
    ft_module.CONFIDENT_THRESHOLD = args.threshold + 0.05
    ...
    try:
        while True:
            ...
            # ── Run detection on EVERY frame for absolute maximum speed ──
            ...
            for det in last_detections:
                ...
                if score >= args.threshold and not found:
                    ...
                    print(f"\n  [ALERT] PERSON DETECTED!  score={score:.3f}")
